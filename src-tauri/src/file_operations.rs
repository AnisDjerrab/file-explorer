...
pub const MIME_ICONS: &[(&str, &str)] = &[
    ...
    ("application/affinity-template", "application-affinity-template"),
    ...
    ("application/mathematicaplayer", "application-mathematicaplayer"),
    ...
    ("application/vnd-google-earth-kml", "application-vnd-google-earth-kml"),
    ("application/vnd.adobe.aftereffects.project", "application-vnd.adobe.aftereffects.project"),
    ...
    ("application/vnd.google-apps.fusiontable", "application-vnd.google-apps.fusiontable"),
    ("application/vnd.google-apps.fusiontable", "gdtable"),
    ("application/vnd.google-apps.map", "application-vnd.google-apps.map"),
    ...
    ("application/vnd.insync.link.drive.doc", "application-vnd.insync.link.drive.doc"),
    ("application/vnd.insync.link.drive.draw", "application-vnd.insync.link.drive.draw"),
    ("application/vnd.insync.link.drive.form", "application-vnd.insync.link.drive.form"),
    ("application/vnd.insync.link.drive.slides", "application-vnd.insync.link.drive.slides"),
    ("application/vnd.insync.link.drive.table", "application-vnd.insync.link.drive.table"),
    ...
    ("application/vnd.ms-excel.spreadsheet.macroenabled.12", "application-vnd.ms-excel.spreadsheet.macroenabled.12"),
    ...
    ("application/vnd.oasis.opendocument.database", "libreoffice-database"),
    ("application/vnd.oasis.opendocument.database", "libreoffice-oasis-database"),
    ("application/vnd.oasis.opendocument.database", "oasis-database"),
    ("application/vnd.oasis.opendocument.database", "openoffice4-database"),
    ("application/vnd.oasis.opendocument.database", "openoffice4-oasis-database"),
    ("application/vnd.oasis.opendocument.database-template", "application-vnd.oasis.opendocument.database-template"),
    ("application/vnd.oasis.opendocument.database-template", "libreoffice-database-template"),
    ("application/vnd.oasis.opendocument.database-template", "libreoffice-oasis-database-template"),
    ("application/vnd.oasis.opendocument.database-template", "oasis-database-template"),
    ("application/vnd.oasis.opendocument.formula", "libreoffice-formula"),
    ("application/vnd.oasis.opendocument.formula", "libreoffice-oasis-formula"),
    ("application/vnd.oasis.opendocument.formula", "oasis-formula"),
    ("application/vnd.oasis.opendocument.formula-template", "libreoffice-formula-template"),
    ("application/vnd.oasis.opendocument.formula-template", "libreoffice-oasis-formula-template"),
    ("application/vnd.oasis.opendocument.formula-template", "oasis-formula-template"),
    ("application/vnd.oasis.opendocument.graphics", "libreoffice-drawing"),
    ("application/vnd.oasis.opendocument.graphics", "libreoffice-oasis-drawing"),
    ("application/vnd.oasis.opendocument.graphics", "oasis-drawing"),
    ("application/vnd.oasis.opendocument.graphics", "openoffice4-drawing"),
    ("application/vnd.oasis.opendocument.graphics", "openoffice4-oasis-drawing"),
    ("application/vnd.oasis.opendocument.graphics-template", "libreoffice-drawing-template"),
    ("application/vnd.oasis.opendocument.graphics-template", "libreoffice-oasis-drawing-template"),
    ("application/vnd.oasis.opendocument.graphics-template", "oasis-drawing-template"),
    ("application/vnd.oasis.opendocument.graphics-template", "openoffice4-drawing-template"),
    ("application/vnd.oasis.opendocument.graphics-template", "openoffice4-oasis-drawing-template"),
    ("application/vnd.oasis.opendocument.presentation", "libreoffice-oasis-presentation"),
    ("application/vnd.oasis.opendocument.presentation", "libreoffice-presentation"),
    ("application/vnd.oasis.opendocument.presentation", "oasis-presentation"),
    ("application/vnd.oasis.opendocument.presentation", "openoffice4-oasis-presentation"),
    ("application/vnd.oasis.opendocument.presentation", "openoffice4-presentation"),
    ("application/vnd.oasis.opendocument.presentation-template", "libreoffice-oasis-presentation-template"),
    ("application/vnd.oasis.opendocument.presentation-template", "libreoffice-presentation-template"),
    ("application/vnd.oasis.opendocument.presentation-template", "oasis-presentation-template"),
    ("application/vnd.oasis.opendocument.presentation-template", "openoffice4-presentation-template"),
    ("application/vnd.oasis.opendocument.spreadsheet", "application-vnd.oasis.opendocument.spreadsheet"),
    ("application/vnd.oasis.opendocument.spreadsheet", "libreoffice-oasis-spreadsheet"),
    ("application/vnd.oasis.opendocument.spreadsheet", "libreoffice-spreadsheet"),
    ("application/vnd.oasis.opendocument.spreadsheet", "oasis-spreadsheet"),
    ("application/vnd.oasis.opendocument.spreadsheet", "openoffice4-oasis-spreadsheet"),
    ("application/vnd.oasis.opendocument.spreadsheet", "openoffice4-spreadsheet"),
    ("application/vnd.oasis.opendocument.spreadsheet-template", "libreoffice-oasis-spreadsheet-template"),
    ("application/vnd.oasis.opendocument.spreadsheet-template", "libreoffice-spreadsheet-template"),
    ("application/vnd.oasis.opendocument.spreadsheet-template", "oasis-spreadsheet-template"),
    ("application/vnd.oasis.opendocument.text", "application-vnd.oasis.opendocument.text"),
    ("application/vnd.oasis.opendocument.text", "libreoffice-empty"),
    ("application/vnd.oasis.opendocument.text", "libreoffice-oasis-empty"),
    ("application/vnd.oasis.opendocument.text", "libreoffice-oasis-text"),
    ("application/vnd.oasis.opendocument.text", "libreoffice-text"),
    ("application/vnd.oasis.opendocument.text", "oasis-empty"),
    ("application/vnd.oasis.opendocument.text", "oasis-text"),
    ("application/vnd.oasis.opendocument.text", "openoffice4-oasis-text"),
    ("application/vnd.oasis.opendocument.text-master", "libreoffice-master-document"),
    ("application/vnd.oasis.opendocument.text-master", "libreoffice-oasis-master-document"),
    ("application/vnd.oasis.opendocument.text-master", "oasis-master-document"),
    ("application/vnd.oasis.opendocument.text-master-template", "libreoffice-master-document-template"),
    ("application/vnd.oasis.opendocument.text-master-template", "libreoffice-oasis-master-document-template"),
    ("application/vnd.oasis.opendocument.text-master-template", "oasis-master-document-template"),
    ("application/vnd.oasis.opendocument.text-template", "application-vnd.oasis.opendocument.text-template"),
    ("application/vnd.oasis.opendocument.text-template", "libreoffice-empty-template"),
    ("application/vnd.oasis.opendocument.text-template", "libreoffice-oasis-empty-template"),
    ("application/vnd.oasis.opendocument.text-template", "libreoffice-oasis-text-template"),
    ("application/vnd.oasis.opendocument.text-template", "libreoffice-text-template"),
    ("application/vnd.oasis.opendocument.text-template", "oasis-empty-template"),
    ("application/vnd.oasis.opendocument.text-template", "oasis-text-template"),
    ("application/vnd.oasis.opendocument.text-template", "openoffice4-oasis-text-template"),
    ("application/vnd.oasis.opendocument.text-template", "openoffice4-text-template"),
    ("application/vnd.oasis.opendocument.text-web", "libreoffice-oasis-web"),
    ("application/vnd.oasis.opendocument.text-web", "libreoffice-oasis-web-template"),
    ("application/vnd.oasis.opendocument.text-web", "libreoffice-web"),
    ("application/vnd.oasis.opendocument.text-web", "libreoffice-web-template"),
    ("application/vnd.oasis.opendocument.text-web", "oasis-web"),
    ("application/vnd.oasis.opendocument.text-web", "oasis-web-template"),
    ...
    ("application/vnd.oziexplorer.plt", "application-vnd.oziexplorer.plt"),
    ("application/vnd.oziexplorer.rte", "application-vnd.oziexplorer.rte"),
    ("application/vnd.oziexplorer.wpt", "application-vnd.oziexplorer.wpt"),
    ("application/vnd.rmaps.sqlite", "application-vnd.rmaps.sqlite"),
    ...
    ("application/vnd.tcpdump.pcap", "org.wireshark.Wireshark-mimetype"),
    ...
    ("application/x-audacity-project", "application-x-audacity-project"),
    ("application/x-audacity-project+sqlite3", "application-x-audacity-project+sqlite3"),
    ...
    ("application/x-bitwig-clip", "com.bitwig.BitwigStudio.application-bitwig-clip"),
    ("application/x-bitwig-device", "application-x-bitwig-device"),
    ("application/x-bitwig-device", "com.bitwig.BitwigStudio.application-bitwig-device"),
    ("application/x-bitwig-extension", "com.bitwig.BitwigStudio.application-bitwig-extension"),
    ("application/x-bitwig-impulse", "com.bitwig.BitwigStudio.application-bitwig-impulse"),
    ("application/x-bitwig-modulator", "com.bitwig.BitwigStudio.application-bitwig-modulator"),
    ("application/x-bitwig-module", "com.bitwig.BitwigStudio.application-bitwig-module"),
    ("application/x-bitwig-package", "com.bitwig.BitwigStudio.application-bitwig-package"),
    ("application/x-bitwig-preset", "com.bitwig.BitwigStudio.application-bitwig-preset"),
    ("application/x-bitwig-project", "com.bitwig.BitwigStudio.application-bitwig-project"),
    ("application/x-bitwig-remote-controls", "com.bitwig.BitwigStudio.application-bitwig-remote-controls"),
    ...
    ("application/x-com.bitwig-clip.BitwigStudio", "application-x-com.bitwig-clip.BitwigStudio"),
    ("application/x-com.bitwig-device.BitwigStudio", "application-x-com.bitwig-device.BitwigStudio"),
    ("application/x-com.bitwig.BitwigStudio", "application-x-com.bitwig.BitwigStudio"),
    ("application/x-compressed-iso", "application-x-compressed-iso"),
    ...
    ("application/x-fender-fenderstudio", "com.fender.studio.application-x.fender-fenderstudio"),
    ("application/x-fender-jamtrack", "com.fender.studio.application-x.fender-jamtrack"),
    ...
    ("application/x-godot-resource", "application-x-godot-resource"),
    ...
    ("application/x-iso9600-appimage", "application-x-iso9600-appimage"),
    ...
    ("application/x-keepassxc", "org.keepassxc.KeePassXC-application-x-keepassxc"),
    ...
    ("application/x-kexiproject-sqlite3", "application-x-kexiproject-sqlite3"),
    ...
    ("application/x-krita-assistant", "application-x-krita-assistant"),
    ("application/x-krita-paintoppresent", "application-x-krita-paintoppresent"),
    ...
    ("application/x-musescore4portable", "application-x-musescore4portable"),
    ("application/x-musescore4portable+xml", "application-x-musescore4portable+xml"),
    ("application/x-nero-burning-rom-image", "gnome-mime-application-x-nero-disk-image"),
    ...
    ("application/x-ptoptimizer-script", "application-x-ptoptimizer-script"),
    ("application/x-python-bytecode", "application-x-python-bytecode"),
    ("application/x-qgis", "qgis-qgs"),
    ("application/x-qgis-layer", "qgis-qlr"),
    ("application/x-qtractor-archive", "org.rncbc.qtractor.application-x-qtractor-archive"),
    ("application/x-qtractor-session", "org.rncbc.qtractor.application-x-qtractor-session"),
    ("application/x-qtractor-template", "org.rncbc.qtractor.application-x-qtractor-template"),
    ("application/x-raw-disk-image", "application-x-raw-disk-image"),
    ("application/x-raw-disk-image-xz-compressed", "application-x-raw-disk-image-xz-compressed"),
    ...
    ("application/x-virtualbox-hdd", "application-x-virtualbox-hdd"),
    ("application/x-virtualbox-hdd", "virtualbox-hdd"),
    ("application/x-virtualbox-ova", "application-x-virtualbox-ova"),
    ("application/x-virtualbox-ova", "virtualbox-ova"),
    ("application/x-virtualbox-ovf", "application-x-virtualbox-ovf"),
    ("application/x-virtualbox-ovf", "virtualbox-ovf"),
    ("application/x-virtualbox-vbox", "application-x-virtualbox-vbox"),
    ("application/x-virtualbox-vbox", "virtualbox-vbox"),
    ("application/x-virtualbox-vbox-extpack", "application-x-virtualbox-vbox-extpack"),
    ("application/x-virtualbox-vbox-extpack", "virtualbox-vbox-extpack"),
    ("application/x-virtualbox-vdi", "application-x-virtualbox-vdi"),
    ("application/x-virtualbox-vdi", "virtualbox-vdi"),
    ("application/x-virtualbox-vhd", "application-x-virtualbox-vhd"),
    ("application/x-virtualbox-vhd", "virtualbox-vhd"),
    ("application/x-virtualbox-vmdk", "application-x-virtualbox-vmdk"),
    ...
    ("application/x-zip-compressed-fb2", "application-x-zip-compressed-fb2"),
    ("application/xml", "application-xml"),
    ("application/xslt+xml", "application-xslt+xml"),
    ("application/yaml", "application-yaml"),
    ("audio/x-dawproject", "com.bitwig.BitwigStudio.audio-x.dawproject"),
    ...
    ("text/x-gettext-translation-template", "text-x-gettext-translation-template"),
    ("text/x-go", "text-x-go"),
...
pub fn cvt_mimetype_iconfilename(mimetype: String) -> String {
    ...
    let mut return_path = format!("{}{}{}", &mime_icons_path, &output_mime_icon_file, &icon_extension);
    let relative_path = format!("{}{}{}", &relative_icon_path, &output_mime_icon_file, &icon_extension);
